...
| R11 | 语言纪律：内部思考/推理/草稿/评审/汇报一律中文；对外按用户主导语言；简洁。**输出标点正常使用（全角，。；：（）），禁以精简为名删标点**。D074/D075/D076/D080 全员适用；**输出卫生**与**任务收口**（思考层禁复述执行意图、100 轮上限、大目标拆分）见 `references/output-discipline.md` |
